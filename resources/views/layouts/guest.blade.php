...
<body class="font-sans text-gray-900 antialiased">
    <div class="flex min-h-screen flex-col items-center bg-gray-50 pt-6 sm:justify-center sm:pt-0 dark:bg-gray-900">
        ...
        <div class="mt-8 w-full overflow-hidden border border-green-100 bg-white px-8 py-10 shadow-[0_20px_50px_rgba(32,200,150,0.1)] sm:max-w-md sm:rounded-3xl dark:border-gray-700 dark:bg-gray-800">
            {{ $slot }}
        </div>
